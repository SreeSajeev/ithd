      ...
      <div className="max-w-[1366px] w-full px-4 py-8">
        ...
        >
          ...
          >
            ...
            >
              <ArrowRightLeft className="w-16 h-16 text-lt-brightBlue" />
            </motion.div>
            <motion.p 
            ...
            >
              This is the Change Request page placeholder — content coming soon.
            </motion.p>
            <motion.p 
            ...
            >
              Here you will be able to submit and track change requests for IT systems.
            </motion.p>
            ...
            >
              <div className="h-2 rounded-full bg-lt-lightGrey"></div>
              <div className="h-2 rounded-full bg-lt-brightBlue"></div>
              <div className="h-2 rounded-full bg-lt-lightGrey"></div>
            </motion.div>
          </motion.div>
        </motion.div>
