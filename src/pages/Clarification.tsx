  ...
  return (
    <div className="helpdesk-bg min-h-screen w-full flex flex-col items-center px-4">
      ...
      <div className="text-center my-8">
        <h1 className="text-glow text-5xl font-bold">Clarification</h1>
      </div>
      ...
      <div className="form-container w-full max-w-4xl p-8 relative">
        ...
        <div className="text-center py-12">
          <p className="text-white text-xl">This is the Clarification page placeholder — content coming soon.</p>
        </div>
      </div>
    </div>
  );
